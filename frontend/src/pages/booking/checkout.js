              ...
              <div className="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                ...
                <div className="flex py-6 px-4 sm:px-6 w-full">
                  <div className="flex-shrink-0 w-3/4">
                    <div dangerouslySetInnerHTML={{ __html: logo }} className="w-20 rounded-md" />
                  </div> 
                </div>
                ...
                <dl className="space-y-6 border-t border-gray-200 py-6 px-4 sm:px-6">
                  <div className="flex items-center justify-between">
                    ...
                    <dd className="text-sm font-medium text-gray-900">$ {bookingForm.consultant.rate * bookingForm.duration}</dd>
                  </div>
                  <div className="flex items-center justify-between">
                    <dt className="text-sm">GST</dt>
                    <dd className="text-sm font-medium text-gray-900">$ {(bookingForm.consultant.rate * bookingForm.duration) * .10}</dd>
                  </div>
                  <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                    <dt className="text-base font-medium">Total</dt>
                    <dd className="text-base font-medium text-gray-900">$ {((bookingForm.consultant.rate * bookingForm.duration) * .10) + bookingForm.consultant.rate * bookingForm.duration}</dd>
                  </div>
                </dl>
