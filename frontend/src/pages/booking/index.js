            ...
            fields: [
              { name: 'description', value: '', cols: 6, type: 'textarea', icon: Bars3CenterLeftIcon, placeholder: '', required: true },
              {
                name: 'serviceType', value: '', cols: 6, type: 'select', icon: BuildingStorefrontIcon, placeholder: '', required: true, options: [
                  ...
                  { name: 'Human resources & organizational development', description: 'This service involves helping businesses develop and implement effective HR policies and practices, as well as optimize organizational structure and processes.' },
                  { name: 'Operations & process improvement', description: 'This service involves helping businesses optimize their operations and processes to increase efficiency and productivity.' },
                  { name: 'Business growth & expansion', description: 'This service involves helping businesses identify and pursue opportunities for growth and expansion, such as entering new markets or launching new products or services.' },
                  { name: 'Legal & compliance', description: 'This service involves helping businesses understand and comply with legal requirements and regulations applicable to their business.' },
                  { name: 'Information technology & digital transformation', description: 'This service involves helping businesses leverage technology and digital tools to drive business growth and efficiency.' },
                  { name: 'Sustainability & corporate social responsibility', description: 'This service involves helping businesses develop and implement strategies for operating in a socially and environmentally responsible manner.' },
                ...
                name: 'consultant', value: '', cols: 6, type: 'multiselect', icon: UserIcon, placeholder: 'Aiden Faulconer', required: true, options: [
                  {
                    ...
                    specialties: ['software', 'digital', 'business', 'graphic design', 'marketing', 'management'],
                    rate: 150,
                  ...
                  },
                  {
                    name: 'James Boon',
                    role: 'Senior business consultant',
                    specialties: ['landscaping', 'contracting', 'business', 'marketing', 'management'],
                    rate: 150,
                    availability: [new Date(), new Date()]
                  },
                  {
