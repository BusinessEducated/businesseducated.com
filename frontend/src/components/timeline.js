...
import {ChatBubbleLeftEllipsisIcon, TagIcon, UserCircleIcon, CheckIcon, HandThumbUpIcon, UserIcon } from '@heroicons/react/20/solid' 
...
const activity = [
  ...
  },
  {
    ...
    tags: [
      ...
      { name: 'Accessibility', href: '#', color: 'bg-red-500' },
    ],
    date: '6h ago',
  },
  {
                            ...
                            <Fragment key={tag.name}>
                              ...
                              >
                                <span className="absolute flex flex-shrink-0 items-center justify-center">
                                  <span
                                    className={classNames2(tag.color, 'h-1.5 w-1.5 rounded-full')}
                                    aria-hidden="true"
                                  />
                                </span>
