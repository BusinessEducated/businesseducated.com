...
// ========================================================================== //
const createCustomValidation = (validationType, validationRequired, validationMessage, validationRegex, oneOf) => {
...
export const useFormStore = (
  ...
  stateDefaultValue = false,
   validationSchema={ValidationType:'phone',validationRequired:true,validationMessage:"This field is required"
   }) => {
