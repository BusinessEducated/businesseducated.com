...
export const GridList = ({ people = [
  ...
  return (
    <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mt-6">
      {people.map(({ email, imageUrl, name, roles, telephone,description, title }) => (
        <li key={email} className="col-span-1 divide-y divide-gray-200 rounded-lg bg-white shadow">
          <div className="flex flex-col w-full items-center justify-between space-x-6 pb-6 hover:-translate-y-5 translate-y-0 ease-in-out transition-all">
            ...
            <img className="h-64 w-full object-contain rounded-t-md bg-red-300" src={imageUrl} alt="" />
            ...
            <div className="w-full pt-5 flex flex-col h-full overflow-hidden mb-12">
              ...
              <p className="mt-1 text-sm text-gray-500 w-full">{description}</p>
            </div>
          ...
          {(email | telephone) && (
            <div>
              <div className="flex divide-x divide-gray-200">
                {email && (<div className="flex w-0 flex-1">
                  <a
                    href={`mailto:${email}`}
