...
const { sanitizationMiddleware, validationMiddleware, validateAllMiddleware } = require('./validation')
...
const secureServer = (
    ...
    if(process.env.NODE_ENV !== 'development') {
        console.log(`enabled the following security options: ${JSON.stringify(enable,null,2)}`);
    }
